...
void recordCommandBuffers()
{
	...
	for (uint32_t i=0; i < g_CommandBuffer.size(); i++)
	{
		...
		// transition the swapchain image format to the presentable image format
		VkImageMemoryBarrier imageMemBarrier = 
		{
			.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER,
			.srcAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT, // TO DO
		...
		vkCmdPipelineBarrier(g_CommandBuffer.at(i),

...
void createGraphicsPipeline()
{
	...
	std::array<VkVertexInputAttributeDescription, 3> getAttributeDescriptions(void);
	...
	std::array<VkVertexInputAttributeDescription,3> attributeDescriptions = getAttributeDescriptions();
...
void createDepthResources()
{
	...
	// {
	// 	std::cout << "has stencil component support\n";
	// }
	// else
	// {
	// 	std::cout << "does not have stencil component support\n";
	// }
